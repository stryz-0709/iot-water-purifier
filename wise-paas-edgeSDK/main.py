...
class App():
  ...
  def __init__(self, master = None):
    ...
    App.hostName.set('rabbitmq-pub.education.wise-paas.com')
    ...
    App.userName.set('EoqrxoPnEPQv:8xQnpnbJOMqD')
    ...
    App.password.set('4duJ8w9xlyD8xDemE9uN')
    ...
    App.nodeId.set('cd848276-a512-40e3-90ea-e614fc667e58')
